    ...
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="w-full max-w-md p-6 bg-white">
        ...
        <form onSubmit={handleSubmit(submitForm)} className="space-y-4">
          <div className="mb-10">
            <label htmlFor="email" className="text-sm font-medium text-gray-700 flex">Email Address</label>
            <input
              type="email"
              id="email"
          ...
          <div className="mt-10">
            <label htmlFor="password" className="text-sm font-medium text-gray-700 flex">Password</label>
            <input
              type="password"
              id="password"
              placeholder="***********"
          ...
          >
            {loading ? <p className="font-semibold">Loading...</p> : <p className="font-semibold">Sign In</p>}
          </button>
          </div>
        </form>
      </div>
